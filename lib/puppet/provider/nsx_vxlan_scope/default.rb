...
Puppet::Type.type(:nsx_vxlan_scope).provide(:default, :parent => Puppet::Provider::Nsx) do
  ...
  Puppet::Type.type(:nsx_vxlan_scope).properties.collect{|x| x.name}.reject{|x| x == :ensure}.each do |prop|
