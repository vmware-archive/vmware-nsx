...
Puppet::Type.type(:nsx_vxlan_map).provide(:default, :parent => Puppet::Provider::Nsx) do
  ...
  Puppet::Type.type(:nsx_vxlan_map).properties.collect{|x| x.name}.reject{|x| x == :ensure}.each do |prop|
